  ...
  companyPage: {
    ...
    info: {
      ...
      rows: [
        ...
        { label: "ຜູ້ອຳນວຍການຕົວແທນ & CEO", value: "Tomoya Kitayama" },
        { label: "ຜູ້ອຳນວຍການຕົວແທນ, CAO", value: "Maiko Mizuno" },
        { label: "ກຳມະການ", value: "Morifumi Yotsumoto" },
        { label: "ກຳມະການ", value: "Kazuyuki Ishikawa" },
        { label: "ກຳມະການ", value: "Shinichiro Kai" },
        { label: "ຜູ້ກວດສອບປະຈຳ", value: "Kazuhiko Osone" },
        { label: "ຜູ້ບໍລິຫານ, CTO", value: "Andreas Alexelis" },
      ],
    },
    history: {
