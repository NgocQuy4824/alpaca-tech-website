...
export function CompanyTeaser({ dict, locale }: { dict: Dictionary; locale: Locale }) {
  ...
  return (
    <section className="flex justify-center bg-at-bg px-5 lg:px-[76px] py-[120px] max-[540px]:py-20">
      <div className="relative w-full max-w-[1288px] bg-gradient-to-br from-at-primary to-at-secondary rounded-[60px] max-[991px]:rounded-[40px] overflow-hidden flex flex-col items-center justify-center px-10 lg:px-[75px] py-[120px]">
        <Image
        ...
        <div className="relative z-10 flex flex-col items-center gap-10 max-w-[1100px] text-center">
          <h2 className="font-[var(--font-montserrat)] text-white text-[72px] max-[991px]:text-[50px] font-extrabold leading-none">
