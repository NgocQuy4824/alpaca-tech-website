...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description: locale === "vi" ? "AIM (SV Digital Software Investment Management) — Mô hình quản lý tài sản bằng AI vận hành ROBOPRO với hơn 40 tỷ yên AUM." : "AIM (SV Digital Software Investment Management) — AI-driven asset management model powering ROBOPRO with over ¥40B in AUM.",
    alternates: {
      languages: {
